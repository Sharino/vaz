...
const YupValidation = (t: any) =>
  yup.object().shape({
    ...
    onWhichFloorNeedsToBeDelivered: yup.number().required(t('form.required')),
    howFarCarCanBeParkedDelivered: yup.string().required(t('form.required')),
...
const LoadFormComponent = (props: any) => {
  ...
  const initialValue = {
    ...
    onWhichFloorNeedsToBeDelivered: data.onWhichFloorNeedsToBeDelivered || '',
              ...
              >
                ...
                <Box mb={1}>
                  ...
                  >
                    ...
                    <Select
                      ...
                      value={houseType}
                      onChange={val => {
                        props.setFieldValue('houseType', val.target.value);
                      }}
                      error={!!props.errors.houseType}
                    >
                      {houseTypes?.map(type => (
                        <MenuItem key={type.title} value={type.key}>
                          {type.title}
                        </MenuItem>
                      ))}
                    </Select>
                ...
                <FormGroup sx={{ mb: 1 }}>
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={wouldYouBeAbleToHelpToLoadTheCarPickup}
                        onChange={e =>
                          props.setFieldValue(
                            'wouldYouBeAbleToHelpToLoadTheCarPickup',
                            e.target.checked
                    ...
                    label={t('form.wouldYouBeAbleToHelpToLoadTheCarPickup')}
                  />
                </FormGroup>
                ...
                <FormGroup sx={{ mb: 1 }}>
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={wouldYouBeAbleToHelpToLoadTheCarDelivered}
                        onChange={e =>
                          props.setFieldValue(
                            'wouldYouBeAbleToHelpToLoadTheCarDelivered',
                            e.target.checked
                    ...
                    label={t('form.wouldYouBeAbleToHelpToLoadTheCarDelivered')}
                  />
                </FormGroup>
              </Box>
              <Box
